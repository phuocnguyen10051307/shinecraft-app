      ...
      <Screen>
        ...
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyText}>
            Hiện tại thông báo cá nhân trên app mobile chỉ mở cho tài khoản khách hàng.
          </Text>
        </View>
      </Screen>
    );
  ...
  return (
    <Screen
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Cập nhật mới từ lịch hẹn, thành viên và khuyến mãi.</Text>
      </View>
      ...
      <View style={styles.hero}>
        ...
        <Pressable
          ...
          {saving ? <ActivityIndicator color="#fff" /> : <Text style={styles.heroButtonText}>Đọc tất cả</Text>}
        </Pressable>
      </View>
      ...
      {items.map((item) => (
        <Pressable
          ...
          <View style={styles.cardTop}>
            ...
            <Text style={styles.dateText}>{item.createdAt ? new Date(item.createdAt).toLocaleString('vi-VN') : ''}</Text>
          </View>
